...
import sys
import time
from gru_prototype_v3 import GRUNet # class definition needed
# build argparser
...
def test(gru_net,args,pred_len,data_dir):
    ...
    for i, batch in enumerate(dataloader):
        ...
        #     plt.plot(out2[s-1:s+pred_len,t,0],out2[s-1:s+pred_len,t,1],color='g',marker='D',linewidth=5,markersize=12)
...
def main(args):
    ...
    avg_testloss,avg_testD_error,avg_testfinalD_error=test(gru_net,args,pred_len,data_dir)
